...
namespace NHN.DTOContracts.ServiceBusConnector.Service
{
    ...
    /// </summary>
    [ServiceContract(Namespace = Namespaces.ServiceBusConnectorV1,
        Name = "IServicebusService")]
    public interface IServicebusService
    {
        /// <summary>
        /// Henter informasjon om en meldings status på service bus.
        /// Hvor det søkes etter meldingen avhenger av køene som er koblet til virksomheten i Adresseregisteret.
        /// </summary>
